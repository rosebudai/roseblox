...
const manifest = { schema_version: 1, profile: "open_world_rpg", version: "0.1.1-experiment", control_profile: "wow_classic_desktop", source_revision: build.source_revision, source_dirty: build.source_dirty, files: {} };
