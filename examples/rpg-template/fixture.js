...
window.fixture = await createRpgGame({
 ...
 characters:[{id:'guide',name:'Guide',model:'person',feet:[-1.6,0,-1],dialogue:{text:'Retrieve the token and return.',choices:[{label:'Test error cleanup',action(){throw new Error('Intentional fixture choice failure')}}]}}, ...(combat?[{id:'enemy',name:'Sentinel',model:'person',feet:[0,0,-2.4],enemy:true,health:40,aggroRange:0}]:[])],
 ...
 abilities:combat?[{name:'Strike',damage:10,cooldown:0},{name:'Mend',heal:12,cooldown:0},{name:'Heal',heal:28,cooldown:0}]:[],
